...
# Pega o diretório exato onde este arquivo Python está localizado
diretorio_atual = Path(__file__).parent

# Junta o caminho do diretório com o nome do arquivo
caminho_arquivo = diretorio_atual / 'arquivo.txt'
...
while editar == 'sim':
    ...
    #with open('C:\Users\155543\Downloads\arquivo.txt','w') as arquivo:
    # Manipula o arquivo usando a variável 'caminho_arquivo'
